              ...
              <div className="col-xl-6 col-lg-6 col-12">
                <div className="wpo-static-hero-inner">
                  <div data-swiper-parallax="300" className="slide-title">
                    <h2>
                      <span>Hello,</span>I am Abdullah Tahir.
                    </h2>
                  </div>
                  ...
                  <div data-swiper-parallax="400" className="slide-text">
                    <p>
                      Junior MERN Stack Developer at Dialogpay | Front-End UI &
                      API Integration Specialist | SEO-Friendly Web Experiences
                      | Content Creator for Dev Tips & Memes 😄 | Building
                      Next-Gen Digital Interfaces
                    </p>
                  </div>
        ...
        <div className="static-hero-img">
          <div className="static-hero-img-inner">
            ...
            <div className="icon-1 floating-item">
              <img src="images/icon/next-js.svg" alt="" />
            </div>
            <div className="icon-2 floating-item">
              <img src="images/icon/nodejs.svg" alt="" />
            </div>
            <div className="icon-3 floating-item">
              <img src="images/icon/mongodb.svg" alt="" />
            </div>
            <div className="icon-3 project floating-item">
              <img src="images/icon/react.svg" alt="" />
            </div>
